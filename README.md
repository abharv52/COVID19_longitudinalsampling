...
This contains a list of new COVID-19 cases in the entire city of Somerville, MA from March-July, 2020, separated into probable, confirmed, and total cases

covid_cases_zip.RDS
This contains a list of new COVID-19 cases in the zip code specific to sampling, from March-July, 2020, separated into probable, confirmed, and total cases
